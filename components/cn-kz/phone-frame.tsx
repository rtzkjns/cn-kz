...
export function PhoneFrame({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh w-full items-center justify-center bg-gradient-to-b from-[#fdeae5] to-[#f6cfc6] p-0 sm:p-6">
      <div className="relative flex h-dvh w-full flex-col overflow-hidden bg-background sm:h-[844px] sm:max-w-[390px] sm:rounded-[2.5rem] sm:border-[6px] sm:border-white sm:shadow-2xl sm:shadow-[#f73b20]/15">
        <StatusBar />
        {/* Header */}
