...
// Сид-список городов для поиска/автодополнения. Груз идёт из ЛЮБОЙ точки (Китай → СНГ,
// либо СНГ → СНГ) в ЛЮБУЮ точку — никаких «популярных» подсказок, только полный поиск.
// ВАЖНО: статический сид (~180 городов). Полная гео-база (Китай + весь СНГ) живёт в БД
// (Supabase `cities`) и подтягивается на бэкенде — здесь мок для автодополнения.
export const ALL_CITIES: string[] = [
  // Китай — происхождение большинства импортных грузов (China → KZ/СНГ)
  "Урумчи", "Хоргос (КНР)", "Алашанькоу", "Кашгар", "Иу", "Гуанчжоу", "Шэньчжэнь",
  "Пекин", "Шанхай", "Ханчжоу", "Гонконг", "Чэнду", "Чунцин", "Сиань", "Ланьчжоу",
  "Циндао", "Тяньцзинь", "Нинбо", "Фошань", "Дунгуань",
  // Казахстан
