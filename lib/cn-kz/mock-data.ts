...
export const MY_ORDERS: Order[] = [
  ...
  },
  {
    ...
    origin: "Урумчи",
    destination: "Алматы",
    cargo: "Автозапчасти, 12 паллет",
    weightKg: 7400,
    volumeM3: 34,
    truckType: "тент",
    priceUsd: 1650,
    readyDate: "8 июл 2026",
    status: "deal",
    shipper: ME_SHIPPER,
    address: "Алматы, ул. Райымбека 200",
    recipientName: "Мурат",
    recipientPhone: "+7 701 555 22 11",
    payment: "transfer",
    createdAgo: "3 дн назад",
    offers: [],
    // Груз уже доставлен → заказчик видит «Подтвердить получение» (demo delivered→completed→оценка).
    deal: {
      status: "delivered",
      carrier: carriers[1],
      agreedPriceUsd: 1650,
      updatedAgo: "2 ч назад",
      crossedBorder: true,
      chat: [
        { id: "m1", fromMe: false, text: "Груз доставил, машина на выгрузке.", time: "14:20" },
        { id: "m2", fromMe: true, text: "Спасибо! Проверю и подтвержу получение.", time: "14:25" },
      ],
    },
  },
  {
